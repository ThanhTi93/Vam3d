...
export default function AdminPage() {
  ...
  const loadData = async (t = tab) => {
    ...
    try {
      ...
      if (t === "collections") {
        ...
        setAiImages(await getAdminAiImages());
      }
    } catch (e) {
  ...
  const handleTab = (t: AdminTab) => { setTab(t); setSearch(""); setIsSidebarOpen(false); };
    ...
    setConfirmDelete({
      ...
      onConfirm: () => {
        ...
        startTransition(async () => {
          try { await fn(); await loadData(); show("Đã xoá thành công!"); }
        ...
        <div className="sticky top-0 z-20 bg-[#090a0f]/95 backdrop-blur border-b border-white/5 px-4 sm:px-8 py-3 sm:py-4 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => startTransition(async () => { await revalidateAllCache(); await loadData(); show("Đã cập nhật cache!"); })}
        ...
        <div className="p-4 sm:p-8">
          ...
          {tab === "movies" && (
            <MoviesTab
              ...
              onRefresh={() => loadData("movies")} show={show}
          ...
          {tab === "categories" && (
            <CategoriesTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("categories")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "episodes" && (
            <EpisodesTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("episodes")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "actors" && (
            <ActorsTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("actors")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "characters" && (
            <CharactersTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("characters")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "galleries" && (
            <GalleriesTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("galleries")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "collections" && (
            <CollectionsTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("collections")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "plans" && (
            <PlansTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("plans")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "features" && (
            <FeaturesTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("features")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "packages" && (
            <PackagesTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("packages")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "authors" && (
            <AuthorsTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("authors")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
          ...
          {tab === "accounts" && (
            <AccountsTab
              ...
              isPending={isPending} startTransition={startTransition}
              onRefresh={() => loadData("accounts")} show={show}
              confirmThenDelete={confirmThenDelete}
            />
          )}
        </div>
      ...
      >
        ...
        >
          ...
          {characters.length >= 3 && (
            <div
              onClick={onPrev}
              className="relative rounded-xl bg-[#090a0f]/40 border border-white/5 cursor-pointer opacity-40 hover:opacity-80 transition-all duration-300 group/side overflow-hidden"
            >
              <img
